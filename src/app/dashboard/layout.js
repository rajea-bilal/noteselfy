  ...
  return (
    <div className="h-screen w-screen flex justify-center">
      ...
      <section className="px-4">
        ...
        <div className="flex gap-6 mt-8 rounded-lg border border-white/20 mb-[5rem] md:mx-2 py-6">
          <aside className=" w-14 md:w-64 transition-all duration-300 text-sm x-lg:px-2 font-medium border-r border-white/20">
            <nav className=" ml-2 flex flex-col justify-center items-center gap-3 md:items-start">
